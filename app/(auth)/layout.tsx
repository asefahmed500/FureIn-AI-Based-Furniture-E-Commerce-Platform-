      ...
      <div className="hidden lg:block relative bg-zinc-950 overflow-hidden">
        ...
        <div className="relative z-10 h-full flex flex-col justify-between p-16">
          <Link href="/" className="flex items-center gap-2 text-white group">
            <div className="h-10 w-10 bg-white rounded-xl flex items-center justify-center transition-transform group-hover:rotate-12">
          ...
          <div className="flex items-center gap-12">
            <div>
              ...
              <p className="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-500 mt-1">Global Citizens</p>
            </div>
            <div>
              <p className="text-3xl font-black text-white">48</p>
              <p className="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-500 mt-1">Design Guilds</p>
            </div>
            <div>
              <p className="text-3xl font-black text-white">100%</p>
              <p className="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-500 mt-1">Authenticity</p>
            </div>
          </div>
        </div>
      </div>
