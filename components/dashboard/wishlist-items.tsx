...
export function WishlistItems({ initialItems }: WishlistItemsProps) {
    ...
    <div className="space-y-12">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-secondary/10 border border-border/50">
          ...
          <span className="text-xs font-black uppercase tracking-widest">{initialItems.length} ARCHIVED PIECES</span>
        </div>
      </div>
            ...
            <div key={item.id} className="group relative flex flex-col rounded-2xl bg-white border border-border/50 overflow-hidden transition-all duration-500 hover:shadow-2xl hover:shadow-primary/5 hover:-translate-y-2">
              ...
              <div className="p-6 space-y-4 flex-grow">
                ...
                <div className="grid grid-cols-2 gap-3 pt-2">
                  ...
                  <Button className="h-12 rounded-xl font-black uppercase tracking-widest text-[10px] shadow-lg shadow-primary/20" onClick={() => handleAddToCart(item)}>
